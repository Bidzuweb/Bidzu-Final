  ...
  useEffect(() => {
    setListings([
      ...
      },
      {
        ...
        price: 80,
        description: "Solid wood coffee table in great condition.",
      ...
      {
        id: "3",
        title: "Apple MacBook Pro 14\" M1",
        price: 1150,
        description: "Excellent condition, barely used, with original charger.",
      ...
      },
      {
        ...
        price: 230,
        description: "Authentic leather handbag, gently used.",
      ...
      },
      {
        ...
        title: "Gaming Chair",
        price: 140,
        description: "Ergonomic chair for PC/console gamers, includes lumbar support.",
      ...
      },
      {
        ...
        price: 325,
        description: "Canon Rebel T7 with 18-55mm lens, great for photography beginners.",
      ...
      },
      {
        ...
        price: 8500,
        description: "Clean title, excellent condition, 120k miles.",
      ...
      },
      {
        ...
        price: 65,
        description: "DOT approved full-face helmet, size L.",
      ...
      },
      {
        ...
        price: 280,
        description: "Used tires with good tread left, 18-inch size.",
        image: "https://via.placeholder.com/300x200?text=Car+Tires",
        type: "fixed",
        category: "Parts"
      }
    ]);
